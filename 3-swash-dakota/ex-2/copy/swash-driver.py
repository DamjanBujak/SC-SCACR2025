...
# black-box code.
di.dprepro(template='template.sws', 
           parameters=params, 
           output='in.sws')
...
result = subprocess.run('swashrun in', shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
...
result = subprocess.run('python postproc.py', shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
print("Output:", result.stdout)
